...
function addon:SetupOptions()
    ...
    category, layout = Settings.RegisterCanvasLayoutCategory(self.optionsFrames.General.frame, self.optionsFrames.General.frame.name, self.optionsFrames.General.frame.name);
	category.ID = self.optionsFrames.General.frame.name
    ...
    category, layout = Settings.RegisterCanvasLayoutCategory(self.optionsFrames.Rotation.frame, self.optionsFrames.Rotation.frame.name, self.optionsFrames.Rotation.frame.name);
