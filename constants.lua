...
if (WOW_PROJECT_ID == WOW_PROJECT_MAINLINE) then
    ...
    addon.glyphs = {
        ...
        MONK = { 125893, 120482, 125673, 146953, 132005, 120479, 123394, 125901, 120477, 125154, 123391, 120483, 125755, 125660, 123334, 125676, 124997, 125678, 146950, 125671, 125732, 125151, 125967, 146954, 125872, 123023, 124989, 146951, 123763, 123405, 123399, 125931, 123403, 123401, 146952 },
