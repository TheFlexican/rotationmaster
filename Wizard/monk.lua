...
function MonkWizard:CreateWindwalkerRotations()
    ...
    local aoeSpells = {
        ...
        -- Spinning Crane Kick - Main AoE Chi spender
        { 
            id = 101546, 
        ...
        { 
            ...
            conditions = {
                type = "BUFF",
                unit = "player",
                spell = "Combo Breaker: Blackout Kick",
                ownbuff = true
            }
        },
    ...
    local aoe = addon.WizardSystem:CreateBasicRotation("Windwalker AoE", aoeSpells)
    
    -- Save rotations and track their names
    local _, singleTargetName = addon.WizardSystem:SaveRotation(singleTarget, specId)
    local _, aoeName = addon.WizardSystem:SaveRotation(aoe, specId)
    
    table.insert(createdRotations, singleTargetName)
    table.insert(createdRotations, aoeName)
